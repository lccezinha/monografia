...
\begin{enumerate}
  \item Contextualizar por meio de referencial teórico sobre métodos ágeis, \textit{Scrum}, XP, testes e qualidade do \textit{software};
...
\section{Desenvolvimento de Software sem testes}
