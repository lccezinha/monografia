...
crie um arquivo \textit{Ruby} no diretório \textit{features/stepdefinitions}, conforme
a Figura \ref{figura_14}.
...
Os arquivos contidos no diretório \textit{features/stepdefinitions} são os arquivos que farão
