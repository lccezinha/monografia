...
onde será construida uma aplicação utilizando as técnicas de teste que foram conceituadas no capítulo anterior e
...
\begin{itemize}
  \item \textit{\textbf{Sprint:}} É um mini-projeto, que tem duração entre uma e quatro semanas
  ...
  \item \textit{\textbf{Dayli Scrum:}} É uma reunião curta e realizada todos os dias pela equipe de desenvolvimento, geralmente ocorre sempre no mesmo horário e tem uma duração de aproximadamente quinze minutos.
