...
\begin{figure}[hbt!]
  \begin{center}
    ...
    \caption{Criando código simples para que os testes passem}
    \label{figura_23}
    Autoria Própria
  \end{center}
\end{figure}
...
\begin{figure}[hbt!]
  \begin{center}
    ...
    \caption{Executando novamente os testes unitários, agoras todos passam}
    \label{figura_24}
    Autoria Própria
  \end{center}
\end{figure}

Agora seguindo para a próxima etapa é preciso realizar refatoração dó código, já que o código
inicial era apenas para sair do estado de vermelho e atingir o estado verde, agora é preciso
entrar no processo de refatoração dentro do TDD e também validar se os testes unitários ainda
...
\begin{figure}[hbt!]
  \begin{center}
    \epsfig{file=images/app-14.png}
    \caption{Executando novamente os testes unitários, todos continuam passando com a refatoração}
    \label{figura_26}
    Autoria Própria
  \end{center}
\end{figure}
