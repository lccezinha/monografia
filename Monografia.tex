...
entre equipes de negócio e desenvolvimento.
...
O surgimento do BDD começou quando Dan North sentiu dificuldades de ensinar a seus alunos TDD,
...
Com o desenvolvimento seguindo essa abordagem é possível verificar como o BDD ainda utiliza o TDD, porém eleva o nível do teste para um nível de especificação, saindo do escopo de apenas estar testando código.
Permite então, que a equipe realmente veja que o código implementado atende
