...
para o projeto, os riscos vão desde atrasos no projeto, demora na resolução de \textit{bugs}, rigidez
...
o desenvolvedor irá se forçar a sempre focar em uma solução simples e que irá resolver o problema
da melhor maneira, e obtendo um \textit{feedback} constante de seu trabalho,
deixando dessa forma, seu código enxuto, simples e com um mínimo de cobertura de testes.
\cite{TDD:Aniche}
...
O editor \textit{Sublime Text} foi escolhido por ser um editor simples, leve, além que de
é flexível e permite a instalação de diversos \textit{plugins} para facilitar o seu uso.
