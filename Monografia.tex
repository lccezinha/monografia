...
\noindent A utilização de testes de \textit{software} em seu processo de desenvolvimento
irá proporcionar um código de melhor qualidade, confiança e segurança.
A utilização de TDD irá ajudar o desenvolvedor a focar na solução simples de seu código,
porém só isso não basta para validar seu correto funcionamento. Visando garantir
que o código entregue atenda as reais necessidades do \textit{software} e também tentando
aproximar equipes de negócio e de desenvolvimento, surge o BDD. O BDD tira o foco do código
para focar no comportamento. Esse trabalho tem como objetivo utilizar as técnicas
de TDD e BDD no desenvolvimento de \textit{software} para demonstrar, através de um
estudo experimental, como o uso adequado dessas técnicas pode melhorar o código e a compreensão
da equipe sobre produto gerado.
\begin{keywords}
...
Porém o TDD foca no código e nas suas melhores práticas, porém para validar se a funcionalidade entregue
...
falem a mesma linguagem e tenha um objetivo único, entregar \textit{software} com qualidade e que atenda
...
É descrição de uma real necessidade do projeto, ou seja, uma funcionalidade esperada no sistema.
É escrita do ponto de vista do usuário e ele deverá descrever o que deseja fazer e como deseja fazer. \cite{GuiaDoScrum}

Segundo \cite{LivroScrumCasaDoCodigo} uma \textit{User Story} pode ser descrita da seguinte forma:
...
Através dessa coleção de \textit{User Stories} o \textit{Product Backlog} será carregado e cada uma será
transformada em uma funcionalidade do sistema.
...
O BDD (Behavior Driven Development ou Desenvolvimento Guiado por Comportamento)
