...
% crie um arquivo \textit{Ruby} no diretório \textit{features/step_definitions}, conforme
% a Figura \textit{figura_14}

% \begin{figure}[hbt!]
%   \begin{center}
%     \epsfig{file=images/app-3.png}
%     \caption{Passos do teste de aceitação}
%     \label{figura_14}
%     Autoria Própria
%   \end{center}
% \end{figure}

% Os arquivos contidos no diretório \textit{features/step_definitions} são os arquivos que farão
% a conexão entre o arquivo de especificação e as classes \textit{Ruby} com o código real da aplicação.

% É preciso criar um \textit{Ruby}
% arquivo chamado
